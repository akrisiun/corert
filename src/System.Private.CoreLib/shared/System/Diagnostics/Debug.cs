...
#endif
{
    ...
    static partial class Debug
    {
        ...
        // internal
        public static Action<string, string, string, string> s_ShowDialog = ShowDialog;

        // internal
        public static Action<string> s_WriteCore = WriteCore;
        ...
        private static void ShowDialog(string stackTrace, string message, string detailMessage, string errorSource)
        {
            ...
            bool result = DeveloperExperience.Default.OnContractFailure(
                 stackTrace, ContractFailureKind.Assert, fullMessage, null, null, null);
            if (!result)
            {
